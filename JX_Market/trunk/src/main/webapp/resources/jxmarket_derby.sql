...
CREATE TABLE T_NEG_ARTIC2ATRIB (
  ...
  ARTI2ATRI_V_DESCR VARCHAR(80) NOT NULL,
...
CREATE TABLE T_NEG_CATEG2ARTIC (
  CAT_N_ID INTEGER NOT NULL,
  ART_N_ID INTEGER NOT NULL,
  CONSTRAINT FK_REL_ARTICULO_FROM FOREIGN KEY (ART_N_ID) REFERENCES T_NEG_ARTICULO (ARTICULO_N_CODIGO),
  CONSTRAINT FK_REL_ATRIBUTO_TO FOREIGN KEY (ATR_N_ID) REFERENCES T_NEG_ATRIBUTO (ATR_N_ID)
);

...
CREATE TABLE T_NEG_CATEGORIA (
  ...
  CATEGORIA_B_ESTADO BOOLEAN NOT NULL DEFAULT TRUE,
  CATEGORIA_N_CODIGO_P BIGINT,
...
CREATE TABLE T_NEG_ARTIC2ATRIB (
  ARTI_N_ID BIGINT NOT NULL,
  ATRI_N_ID BIGINT NOT NULL,
...
CREATE TABLE T_NEG_INVENTARIO (
  INVE_N_ID BIGINT NOT NULL,
  ARTI_N_ID BIGINT NOT NULL,
  INVE_D_STOCK DECIMAL(8,2),
  INVE_D_RESERVA DECIMAL(8,2),
  INVE_F_FECHA DATE,
...
CREATE TABLE T_NEG_PRECIO (
  PREC_N_ID BIGINT NOT NULL,
  ARTI_N_ID BIGINT NOT NULL,
  PREC_F_DESDE DATE,
  PREC_F_HASTA DATE,
  PREC_D_MONTO DECIMAL(14,4),
...
CREATE TABLE T_NEG_COSTO (
  COST_N_ID BIGINT NOT NULL,
  ARTI_N_ID BIGINT NOT NULL,
  COST_F_DESDE DATE,
  COST_F_HASTA DATE,
  COST_D_MONTO DECIMAL(14,4),
...
CREATE TABLE T_NEG_OFERTA (
  OFER_N_ID BIGINT NOT NULL,
  ARTI_N_ID BIGINT NOT NULL,
  OFER_F_DESDE DATE,
  OFER_F_HASTA DATE,
  OFER_D_MONTO DECIMAL(14,4),

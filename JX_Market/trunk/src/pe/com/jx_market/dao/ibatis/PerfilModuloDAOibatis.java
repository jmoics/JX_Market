...
public class PerfilModuloDAOibatis
    extends SqlMapClientDaoSupport
    implements PerfilModuloDAO
{
    ...
    @Override
    public Set<String> listaModulosPorPerfil(final DTO_Perfil perfil)
    {
        final List<String> lista = getSqlMapClientTemplate().queryForList("getModuloStringXPerfil", perfil);
        final Set listaSet = new HashSet(lista);
        return listaSet;
    }

...
--
-- Table structure for table T_SEG_MODULE_ACCESSUI
--

DROP TABLE IF EXISTS T_SEG_MODULE_ACCESSUI;
CREATE TABLE T_SEG_MODULE_ACCESSUI (
  ID BIGINT NOT NULL,
  MODULEID BIGINT NOT NULL,
  NAMEUI VARCHAR(80) DEFAULT NULL,
  PRIMARY KEY (ID),
  CONSTRAINT FK_REL_ACCESSUI_MODULE FOREIGN KEY (MODULEID) REFERENCES T_SEG_MODULE (ID)
);

--
-- Table structure for table T_SEG_MODULE_WIDGETUI
--

DROP TABLE IF EXISTS T_SEG_MODULE_WIDGETUI;
CREATE TABLE T_SEG_MODULE_WIDGETUI (
  ID BIGINT NOT NULL,
  ACCESSUIID BIGINT NOT NULL,
  NAMEUI VARCHAR(80) DEFAULT NULL,
  PRIMARY KEY (ID),
  CONSTRAINT FK_REL_WIDGETUI_ACCESSUI FOREIGN KEY (ACCESSUIID) REFERENCES T_SEG_MODULE_ACCESSUI (ID)
);
...
DROP TABLE IF EXISTS T_BUS_PARAMTYPE;
...
DROP TABLE IF EXISTS T_BUS_PARAMETER;
...
--
-- Table structure for table T_BUS_ATRIBUTO
--
...
DROP TABLE IF EXISTS T_BUS_PRICELIST;
...
DROP TABLE IF EXISTS T_BUS_PRICELISTCOST;
...
DROP TABLE IF EXISTS T_BUS_PRICELISTRETAIL;
...
CREATE SEQUENCE T_BUS_PRICELIST_ID_SEQ;
ALTER TABLE T_BUS_PRICELIST ALTER COLUMN ID SET DEFAULT nextval('T_BUS_PRICELIST_ID_SEQ');
ALTER SEQUENCE T_BUS_PRICELIST_ID_SEQ OWNED BY T_BUS_PRICELIST.ID;
...
CREATE SEQUENCE T_NEG_DBTYPE_ID_SEQ;
ALTER TABLE T_NEG_DBTYPE ALTER COLUMN ID SET DEFAULT nextval('T_NEG_DBTYPE_ID_SEQ');
ALTER SEQUENCE T_NEG_DBTYPE_ID_SEQ OWNED BY T_NEG_DBTYPE.ID;
...
CREATE SEQUENCE T_SEG_MODULE_ACCESSUI_ID_SEQ;
ALTER TABLE T_SEG_MODULE_ACCESSUI ALTER COLUMN ID SET DEFAULT nextval('T_SEG_MODULE_ACCESSUI_ID_SEQ');
ALTER SEQUENCE T_SEG_MODULE_ACCESSUI_ID_SEQ OWNED BY T_SEG_MODULE_ACCESSUI.ID;

CREATE SEQUENCE T_SEG_USER_ID_SEQ;
ALTER TABLE T_SEG_MODULE_WIDGETUI ALTER COLUMN ID SET DEFAULT nextval('T_SEG_MODULE_WIDGETUI_ID_SEQ');
ALTER SEQUENCE T_SEG_MODULE_WIDGETUI_ID_SEQ OWNED BY T_SEG_MODULE_WIDGETUI.ID;

...
CREATE TABLE T_BUS_PRICELIST (
  ...
  CONSTRAINT FK_REL_PRICELIST_DBTYPE FOREIGN KEY (TYPEID) REFERENCES T_NEG_DBTYPE (ID),
...
DROP TABLE IF EXISTS T_NEG_DBTYPE;
CREATE TABLE T_NEG_DBTYPE (
  ID BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1),
  PARENTID BIGINT,
  NAME VARCHAR(50),
  CONSTRAINT FK_REL_DBTYPE_DBTYPE FOREIGN KEY (PARENTID) REFERENCES T_NEG_DBTYPE (ID)
);

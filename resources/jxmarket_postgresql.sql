...
CREATE SEQUENCE T_BUS_UBICATION_ID_SEQ;
ALTER TABLE T_BUS_UBICATION ALTER COLUMN ID SET DEFAULT nextval('T_BUS_UBICATION_ID_SEQ');
ALTER SEQUENCE T_BUS_UBICATION_ID_SEQ OWNED BY T_BUS_UBICATION.ID;
...
CREATE SEQUENCE T_SEG_MODULE_WIDGETUI_ID_SEQ;

...
/**
 * The class is the exception class used to throw exception. This exceptions are
 * shown in the user interface (web browser). The exception text stands in the
 * properties. The key value in the property is the name of the class (
 ...
 * @version $Id$
 */
public class JXMarketException
    extends Exception
{
     ...
     */
    public JXMarketException(final Class<?> _className,
                             final String _id,
                             final Object... _args)
    {
     ...
     * @param _cause cause
     */
    public JXMarketException(final String _message,
                             final Throwable _cause)
    {
        super(_message, _cause);
        if (_cause instanceof JXMarketException) {
            final JXMarketException cause = (JXMarketException) _cause;
            this.id = cause.getId();

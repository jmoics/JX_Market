...
CREATE TABLE `T_SEG_MODULO` (
  ...
  KEY `FK_REL_COMPANY_MODULO` (`COMPANY_N_CODIGO`),
  CONSTRAINT `FK_REL_COMPANY_MODULO` FOREIGN KEY (`COMPANY_N_CODIGO`) REFERENCES `T_COM_COMPANY` (`COMPANY_N_CODIGO`)
...
CREATE TABLE `T_SEG_PERFIL` (
  ...
  KEY `FK_REL_COMPANY_PERFIL` (`COMPANY_N_CODIGO`),
  KEY `FK_REL_PERFIL_AREA` (`AREA_N_CODIGO`),
  CONSTRAINT `FK_REL_COMPANY_PERFIL` FOREIGN KEY (`COMPANY_N_CODIGO`) REFERENCES `T_COM_COMPANY` (`COMPANY_N_CODIGO`),
